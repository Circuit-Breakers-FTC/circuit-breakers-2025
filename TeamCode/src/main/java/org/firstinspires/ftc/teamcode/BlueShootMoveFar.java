...
@Autonomous
@Config
public class BlueShootMoveFar extends LinearOpMode {
    ...
    public static double SHOT1_X = 54;
    public static double SHOT1_Y = 9;
    public static double SHOT1_ANGLE = 154;
    ...
    public static double END_AUTO_Y = 36;
    public static double END_AUTO_X = 65;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        // --- INITIAL POSITIONS ---
        Pose2d beginPose = new Pose2d(62.5,16.5*blueAuto(), Math.toRadians(270));
