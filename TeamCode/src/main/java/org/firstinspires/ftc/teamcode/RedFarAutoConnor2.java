...
@Autonomous
@Config
public class RedFarAutoConnor2 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        // --- INITIAL POSITIONS ---
        Pose2d beginPose = new Pose2d(62.5,(16.5*blueAuto())+blueAutoY(), Math.toRadians(90));
        GoBildaPinpointDriver driver = hardwareMap.get(GoBildaPinpointDriver.class, "pinpoint");
        driver.resetPosAndIMU();

        // Bin position/drop off position
        Pose2d shotPose = new Pose2d(SHOT1_X, SHOT1_Y*blueAuto()+blueAutoY(), Math.toRadians(shotAngle()));
                ...
                new ParallelAction(
                        ...
                        drive.actionBuilder(beginPose)
                                ...
                                */
                                ...
                                .strafeToLinearHeading(new Vector2d(FIRST_PICKUP_X, PICKUP_Y*blueAuto()+blueAutoY()), Math.toRadians(PICKUP_ANGLE*blueAuto()))
                                ...
                                .strafeToLinearHeading(new Vector2d(SHOT1_X, SHOT1_Y*blueAuto()+blueAutoY()), Math.toRadians(shotAngle()))
                                ...
                                .strafeToLinearHeading(new Vector2d(human_player_pickup_backup_x,human_player_pickup_backup_y*blueAuto()+blueAutoY()), Math.toRadians(0))
                                .strafeToLinearHeading(new Vector2d(human_player_pickup_x,human_player_pickup_backup_y*blueAuto()+blueAutoY()), Math.toRadians(0))
